...
static class DeploymentController
{
	...
	private static void DoDeployClick()
	{
		...
		int row = 0;
		int col = 0;
        // Sarah: fixed ships being deployed 3 tiles beneath where the user clicks
        // changed added '- UtilityFunctions.FIELD_TOP' to calculation of 'row', 
        // to account for the displacement of the grid from the top of the screen
